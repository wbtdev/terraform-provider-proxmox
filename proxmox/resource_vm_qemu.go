...
func resourceVmQemuCreate(d *schema.ResourceData, meta interface{}) error {
  ...
  if vmr == nil {
    ...
    if d.Get("clone").(string) != "" {
      ...
      configPostClone, err := pxapi.NewConfigQemuFromApi(vmr, client)
      logger.Debug().Str("vmid", d.Id()).Msgf("Original disks: '%+v', Clone Disks '%+v'", config.QemuDisks, configPostClone.QemuDisks)
      ...
      for slot, disk := range configPostClone.QemuDisks {
